...
class BilingualDataset(Dataset):
    def __init__(self,ds,tokenizer_src,tokenizer_tgt,src_lang,tgt_lang,seq_len) ->None:
        ...
        self.sos_token = torch.tensor([tokenizer_src.token_to_id("[SOS]")] , dtype=torch.int64) ## index of the SOS token in the source tokenized data 
        self.eos_token = torch.tensor([tokenizer_src.token_to_id("[EOS]")] , dtype=torch.int64) ## index of the EOS token in the source tokenized data 
        self.pad_token = torch.tensor([tokenizer_src.token_to_id("[PAD]")] , dtype=torch.int64) ## index of the PAD token in the source tokenized data 
